    ...
    <div class="container-fluid">
      <footer class="py-5">
        <div class="row text-center">
          <div class="col-3">
            <div class="m-1">
              <img src="<?php echo $path; ?>/resources/images/new/payment.png" alt="payment">
              <br>
              <br>
          ...
          <div class="col-3">
            <div class="m-1">
              <img src="<?php echo $path; ?>/resources/images/new/Quality.png" alt="Quality">
              <br>
              <br>
          ...
          <div class="col-3">
            <div class="m-1">
              <img src="<?php echo $path; ?>/resources/images/new/Guarantee.png" alt="Guarantee">
              <br>
              <br>
          ...
          <div class="col-3">
            <div class="m-1">
            <img src="<?php echo $path; ?>/resources/images/new/Support.png" alt="Support">
            <br>
            <br>
